...
std::vector<double> tbsla::cpp::Matrix::page_rank(double epsilon, double beta, int max_iteration, int &nb_iterations_done){
...
std::vector<double> tbsla::cpp::Matrix::personalized_page_rank(double epsilon, double beta, int max_iteration, std::vector<int> personalized_nodes, int &nb_iterations_done){
